...
#    #TODO: FIX THIS
    ...
    E_tr, L_tr = collect(train_loader, args.max_tsne_train, embedder, head, device=device)
    E_t, L_te = collect(test_loader,  args.max_tsne_test, embedder, head, device=device)
